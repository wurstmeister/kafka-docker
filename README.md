...
* **03-Apr-2018** - *BREAKING* - `KAFKA_ZOOKEEPER_CONNECT` is now a mandatory environment var (see examples).
...
To see how different parameters and environment vars are set please refer to various docker-compose*.yml files on github:
...
* https://github.com/wurstmeister/kafka-docker/blob/master/test/docker-compose.yml
